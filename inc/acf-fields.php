    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'required' => 0,
                'sub_fields' => [
                    ['key' => 'field_stype_tar_title', 'label' => 'Назва', 'name' => 'title', 'type' => 'text', 'required' => 1],
                    ['key' => 'field_stype_tar_desc', 'label' => 'Опис', 'name' => 'desc', 'type' => 'textarea', 'rows' => 4],
                    ['key' => 'field_stype_tar_btn_text', 'label' => 'Текст кнопки', 'name' => 'btn_text', 'type' => 'text', 'default_value' => 'Детальніше'],
                    [
                        'key' => 'field_stype_tar_btn_action',
                        'label' => 'Дія кнопки',
                        'name' => 'btn_action',
                        'type' => 'select',
                        'choices' => ['link' => 'Посилання', 'popup' => 'Popup', 'phone' => 'Телефон', 'scroll' => 'Скрол'],
                    ...
                    ['key' => 'field_stype_tar_btn_value', 'label' => 'Значення кнопки (URL / id / телефон)', 'name' => 'btn_value', 'type' => 'text'],
                ],
            ],
